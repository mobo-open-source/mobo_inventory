...
class PickingFilterBottomSheet extends StatefulWidget {
  final PickingProvider provider;
  final VoidCallback? onClearSearch;
  const PickingFilterBottomSheet({
    super.key,
  ...
  @override
  State<PickingFilterBottomSheet> createState() =>
      _PickingFilterBottomSheetState();
}

class _PickingFilterBottomSheetState extends State<PickingFilterBottomSheet>
  ...
  void initState() {
    ...
    _tempStates = List.from(widget.provider.states);
                    ...
                    child: OutlinedButton(
                      onPressed: () {
                        ...
                        Future.microtask(() async {
                          ...
                          await widget.provider.fetchPickings();
                        });
                      },
              ...
              Expanded(
                child: OutlinedButton.icon(
                  onPressed: () async {
                    ...
                    if (date != null) setState(() => _tempStartDate = date);
                  },
              ...
              Expanded(
                child: OutlinedButton.icon(
                  onPressed: () async {
                    ...
                    if (date != null) setState(() => _tempEndDate = date);
                  },
                  icon: const Icon(HugeIcons.strokeRoundedCalendar03, size: 16),
                  label: Text(
                    _tempEndDate != null
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Organize pickings by different attributes',
