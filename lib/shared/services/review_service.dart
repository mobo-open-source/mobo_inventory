...
import '../../../main.dart'; // From mobo_inventory/lib/shared/services/review_service.dart -> main.dart is 2 levels up if Core is not there. Wait: lib/shared/services -> 3 levels up to lib -> main.dart is inside lib.
    ...
    try {
      final Uri emailLaunchUri = Uri(
        ...
        query: encodeQueryParameters(<String, String>{
          'subject':
              'Feedback for mobo Inventory for Odoo (${rating.toInt()} Stars)',
          'body':
              'Rating: ${rating.toInt()}/5\n\nComment:\n$comment\n\n---\nSent from Mobo Inventory for Odoo',
        }),
      );
